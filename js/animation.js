...
railSpriteSheet.src="img/railswsupport_spriteSheet.png";
const railEndSpriteSheet = new Image();
railEndSpriteSheet.src="img/railsend_spriteSheet.png";
const railEndFlippedSpriteSheet = new Image();
railEndFlippedSpriteSheet.src="img/railsend_flipped_spriteSheet.png";
...
function changeImg(){
  ...
  if(img.src.match("button_unpressed.png")){
    ...
    bttnState = false;
    img.src = "img/button_unpressed.png";
  }
}
